...
import { SiSymfony, SiPhp, SiSwagger, SiMysql, SiNextdotjs, SiReact, SiAngular, SiTailwindcss, SiStorybook, SiGitlab, SiTrello, SiLinux, SiJira, SiOpenapiinitiative } from "react-icons/si";
  ...
  const skillCategories = [
    {
      ...
      icon: <FileCog className="w-5 h-5 text-primary" />,
      skills: [
        { name: "Recueil du besoin", logo: null },
        { name: "User stories", logo: null },
        { name: "MVP", logo: null },
    ...
    },
    {
      ...
      skills: [
        { name: "Roadmap", logo: null },
        { name: "Gestion des risques", logo: null },
        { name: "Trello", logo: <SiTrello className="w-4 h-4 mr-2" /> },
        { name: "Jira", logo: <SiJira className="w-4 h-4 mr-2" /> },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "OpenAPI", logo: <SiOpenapiinitiative className="w-4 h-4 mr-2" /> },
        { name: "MySQL", logo: <SiMysql className="w-4 h-4 mr-2" /> },
      ],
      color: "border-blue-500 text-blue-500 bg-blue-500/10",
    },
    {
      title: "Architecture & qualite",
      icon: <Container className="w-5 h-5 text-emerald-500" />,
      skills: [
        { name: "Architecture applicative", logo: null },
        { name: "Conventions de code", logo: null },
        { name: "Lisibilite du code", logo: null },
        { name: "Tests unitaires", logo: null },
      ...
      <div className="max-w-5xl mx-auto space-y-12">
        <div className="text-center space-y-4">
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight">
            Analyse, delivery <span className="text-secondary">& expertise technique</span>
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Un positionnement hybride entre analyse fonctionnelle, pilotage de projet et execution
            technique pour faire avancer les sujets de facon concrete.
          </p>
        </div>
